...
public class UniqueImages {
	public static class Image {
		...
		public boolean equals(Object other) {
			...
			//Equals comparing FirstName with Case Ignorance
		...
		public int hashCode() {
			final int prime = 31;
			int result = 1;
			int filenameHashcode;
			if (filename == null) {
				filenameHashcode = 0;
			} else {
				String[] components = filename.split("\\.");
				filenameHashcode = components[0].toLowerCase().hashCode();
			}
			
			result = prime * result + filenameHashcode;
